...
args:
  client_options:
    ...
    redirect_uri: "https://gitlab.local.me/users/auth/openid_connect/callback"
    authorization_endpoint: "https://keycloak.local.me/realms/master/protocol/openid-connect/auth"
  ...
  discovery: false
  issuer: "https://keycloak.local.me/realms/master"
